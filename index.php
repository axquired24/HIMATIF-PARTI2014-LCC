...
<html lang="en">
  <head>
    ...
    <title>LCC 2014 | by Himatif UMS</title>
  ...
  <body>
    ...
    <div id="outer-container">
      ...
      <section id="left-sidebar">
        ...
        <ul id="main-menu">
          <li id="menu-item-text" class="menu-item scroll"><a href="#text">Sekilas LCC</a></li>
          <li id="menu-item-carousel" class="menu-item scroll"><a href="#carousel">Persyaratan</a></li>
          <li id="menu-item-grid" class="menu-item scroll"><a href="#grid">Kontak Panitia</a></li>
          <li id="menu-item-contact" class="menu-item scroll"><a href="#contact">Pendaftaran Peserta</a></li>
        </ul><!-- #main-menu -->
      ...
      <section id="main-content" class="clearfix">
          ...
          <div class="content-wrapper clearfix wow fadeInDown" data-wow-delay="0.3s">
            <div class="col-sm-10 col-md-9 pull-right">
                ...
                <section class="feature-text">
                  ...
                  <p>Calon peserta Lomba Cerdas Cermat TIK 2014 Tingkat SMA/SMK Se-Eks Karisedanan Surakarta.</p>
        ...
        <article id="text" class="section-wrapper clearfix" data-custom-background-img="assets/images/other_images/bg1.jpg">
          <div class="content-wrapper clearfix">
            <div class="col-sm-10 col-md-9 pull-right">
                ...
                <h1 class="section-title">Sekilas Tentang LCC</h1>
        ...
        <article id="grid" class="section-wrapper clearfix" data-custom-background-img="assets/images/other_images/bg2.jpg">
          <div class="content-wrapper clearfix">
            <div class="col-sm-11 col-md-10 pull-right">
                ...
                <h1 class="section-title">Kontak Panitia</h1>
        ...
        <article id="contact" class="section-wrapper clearfix" data-custom-background-img="assets/images/other_images/bg4.jpg">
          <div class="content-wrapper clearfix">
              ...
              <h1 class="section-title">Pendaftaran Peserta</h1>
              
                <!-- CONTACT FORM -->
                <div class="col-sm-12 col-md-12">
                  <form method="POST" class="form-style clearfix" action="tambah.php" enctype="multipart/form-data" role="form">

                    <!-- form left col -->
                    <div class="col-md-6">
											<h6 title="Diisi urut dari ketua(Peserta 1) dan anggota(Peserta 2 & 3)">Data Peserta </h6>
											<?php for($d=1; $d<4; $d++){ ?>											  
											<hr>
                      <div class="form-group">
                        <input type="text" class="text-field form-control validate-field required" data-validation-type="string" id="form-nama<?php echo $d; ?>" placeholder="Nama Peserta <?php echo $d; ?>" name="nama<?php echo $d; ?>">
                      </div>  
                      <div class="form-group">
                        <input type="tel" class="text-field form-control validate-field phone required" data-validation-type="phone" id="form-kelas<?php echo $d; ?>" placeholder="Kelas" name="kelas<?php echo $d; ?>">
                      </div>
                      <div class="form-group">
                        <input type="tel" class="text-field form-control validate-field phone required" data-validation-type="phone" id="form-telepon<?php echo $d; ?>" placeholder="Telepon" name="telepon<?php echo $d; ?>">
                      </div>
											<?php }; ?>  
                    ...
                    <!-- form right col -->
                    <div class="col-md-6">
											<h6 title="Diisi sesuai data sekolah">Data Sekolah </h6>
											<hr>										
                      <div class="form-group">
                        <input type="text" class="text-field form-control validate-field required" data-validation-type="string" id="form-name" placeholder="Nama Sekolah" name="nama_sekolah">
                      </div>  
                      <div class="form-group">
                        <input type="email" class="text-field form-control validate-field required" data-validation-type="email" id="form-email" placeholder="Email Sekolah" name="email">
                      </div>
                      <div class="form-group">
                        <input type="tel" class="text-field form-control validate-field phone required" data-validation-type="phone" id="form-contact-number" placeholder="Telepon" name="telepon_sekolah">
                      </div>																					
                      <div class="form-group">
                        <textarea placeholder="Alamat Sekolah..." class="form-control validate-field required" name="alamat_sekolah"></textarea>
                      </div> 
                      <div class="form-group">
                      <div class="form-group">
                        <textarea placeholder="Pesan untuk kami? :) ..." class="form-control validate-field" name="pesan"></textarea>
                      </div> 
                      <div class="form-group">
